...
# Postgres.app bundles GDAL/GEOS/PROJ — point Django GeoDjango to them
_PG_LIB = "/Applications/Postgres.app/Contents/Versions/17/lib"
GDAL_LIBRARY_PATH = f"{_PG_LIB}/libgdal.dylib"
GEOS_LIBRARY_PATH = f"{_PG_LIB}/libgeos_c.dylib"
